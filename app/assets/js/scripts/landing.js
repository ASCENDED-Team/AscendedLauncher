  ...
  if (authUser != null) {
    ...
    if (authUser.uuid != null) {
      document.getElementById(
        "account_avatar"
      ).src = `https://mc-heads.net/head/${authUser.uuid}/left`;
    }
  }
...
function updateSelectedServer(serv) {
  ...
  ConfigManager.save();
  server_selection_name.innerHTML =
...
server_selection_name.innerHTML = Lang.queryJS(
  "landing.selectedServer.loading"
);
