...
remote.getCurrentWebContents().on("devtools-opened", () => {
  ...
  console.log(
    "%cIf you've been told to paste something here, you're being scammed.",
    "font-size: 16px"
  );
  console.log(
    "%cUnless you know exactly what you're doing, close this window.",
    "font-size: 16px"
  );
});
    ...
    switch (arg) {
      ...
      case "update-available":
        ...
        if (process.platform === "darwin") {
          info.darwindownload = `https://github.com/dscalzi/HeliosLauncher/releases/download/v${
            info.version
